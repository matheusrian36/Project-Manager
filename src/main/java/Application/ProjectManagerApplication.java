...
import Workers.ProjectDAO;
import Workers.ProjetoImpl;
...
public class ProjectManagerApplication {
    public static void main(String[] args) {
        ProjectDAO dao = new ProjetoImpl();
        int opcao;
        do{
            ...
            try {
                switch (opcao){
                    ...
                    case 2:
                        ...
                        Project projetoNovo = new Project();
                    ...
                    case 4:
                        ...
                        Project projetoEncontrado = dao.consultarPorNome(nomeConsultado);
